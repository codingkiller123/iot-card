package com.xdm.common.core.web.controller;
...
import com.xdm.common.core.constant.HttpStatus;
import com.xdm.common.core.utils.DateUtils;
import com.xdm.common.core.utils.StringUtils;
import com.xdm.common.core.utils.sql.SqlUtil;
...
public class BaseController {
    ...
    protected TableDataInfo getHttpDataTable(List<?> list, Long totalNum) {
        TableDataInfo rspData = new TableDataInfo();
        rspData.setCode(HttpStatus.SUCCESS);
        rspData.setRows(list);
        rspData.setMsg("查询成功");
